...
```bash
cp <skill-dir>/.env.example ~/.config/skills/jz-connect-mac/.env
chmod 600 ~/.config/skills/jz-connect-mac/.env
```
...
2. `~/.config/skills/jz-connect-mac/.env`。
...
- `~/.config/skills/jz-connect-mac/.env` 必须 `chmod 600`，不提交到 git。
