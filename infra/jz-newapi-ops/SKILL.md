...
```text
~/.config/skills/jz-newapi-ops/.env
~/.config/skills/jz-newapi-ops/fallback-plan.json
```
...
NEWAPI_SSH_USER=
NEWAPI_SSH_PORT=22
NEWAPI_REMOTE_DIR=/opt/new-api
NEWAPI_DB=/opt/new-api/data/one-api.db
...
```json
{
  "managed_tag": "course-managed",
  "generated_tag": "course-fallback-generated",
  "retry_times": 3,
  "primary": [
    {
...
```text
5 0 * * * /opt/new-api/reset-course-token-quota.sh >> /opt/new-api/logs/quota-reset.log 2>&1
```
