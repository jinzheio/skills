...
# No sshpass — fall back to interactive with displayed password
echo "[login-hetzner] sshpass not installed. Starting interactive SSH."
echo "[login-hetzner] password=${password}"
if [[ -n "$remote_cmd" ]]; then
